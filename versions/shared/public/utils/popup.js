    ...
    buttons : [
        {
            ...
            close   : <boolean> - auto remove popup after click
        }
    ]
...
window.Popup = function( s ){
    ...
    if(s.zIndex) this.$element.zIndex = s.zIndex;
    ...
    if( typeof s.padding != 'undefined' ) this.$body.style.padding = s.padding + 'px';
    ...
    if(s.modal){
        ...
        if(s.zIndex) this.$modal.zIndex = s.zIndex;
        s.draggable = false;
